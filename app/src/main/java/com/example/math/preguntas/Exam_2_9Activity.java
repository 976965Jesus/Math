...
public class Exam_2_9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_continuar = (Button) findViewById(R.id.btn_continua2_9);
        textArea = (EditText) findViewById(R.id.input_res9);
    ...
    public void onBackPressed() {
        ...
        alertOpciones.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(Exam_2_9Activity.this, MenuActivity.class);
    ...
    public void Pregunta(){
        if(Materia == 1){
            ...
            question.setText("Efectué la siguiente conversion de temperatura: " + alumno.getDigito1() + " [K] --> R");
    ...
    public void respuestaContinuar(View view){
        ...
        if(Materia == 1){
            ...
            double resDouble = RespuestaMeteria9();
    ...
    //Metodo Respuesta 1
    public double RespuestaMeteria9(){

        //Texto de Pregunta
        //TVPregunta.setText("Efectué la siguiente conversion de temperatura: " + alumno.getDigito1() + " [K] --> R");

        //parte Simplificada y optimizada
        double div = (double) 9/5;
        double mult = div * (alumno.getDigito1()-273);
        double sum = mult + 32;
