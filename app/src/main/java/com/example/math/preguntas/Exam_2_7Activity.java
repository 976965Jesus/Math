...
public class Exam_2_7Activity extends AppCompatActivity {
    ...
    RelativeLayout ll;
    TextView question;
    Button btn_continua7;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_exam_2_7);

        Bundle bundleRecibido = getIntent().getExtras();
        alumno = (Alumno) bundleRecibido.getSerializable("Alumno");
        Materia = (int) bundleRecibido.getInt("Materia");

        btn_continuar = (Button) findViewById(R.id.btn_continua2_7);
        textArea = (EditText) findViewById(R.id.input_res7);

        ll = (RelativeLayout) findViewById(R.id.relative_exam2_7);
        question = (TextView) findViewById(R.id.question_7);
        btn_continua7 = (Button) findViewById(R.id.btn_continua2_7);
    ...
    public void onBackPressed() {
        ...
        alertOpciones.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(Exam_2_7Activity.this, MenuActivity.class);
    ...
    public void Pregunta(){
        if(Materia == 1){
            ...
            question.setText("Efectué la siguiente conversion de temperatura: " + alumno.getDigito1() + " [°C] --> K");
    ...
    public void respuestaContinuar(View view){
        ...
        if(Materia == 1){
            ...
            double resDouble = RespuestaMeteria7();
    ...
    //Metodo Respuesta 1
    public double RespuestaMeteria7(){

        //Texto de Pregunta
        //TVPregunta.setText("Efectué la siguiente conversion de temperatura: " + alumno.getDigito1() + " [°C] --> K");

        //parte Simplificada y optimizada
        double respuesta = alumno.getDigito1() + 273;
    ...
    public void abrirSiguientePregunta(){
        Intent intent = new Intent(Exam_2_7Activity.this, Exam_2_8Activity.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable("Alumno", alumno);
        intent.putExtras(bundle);
    ...
    public void guardarPreferencias(){
        ...
        indica = misPreferencias.getString("indicadorExam2_7","");
    }
    ...
    public void cargarPreferencias(){
        ...
        editor.putString("indicadorExam2_7",tema);
        editor.commit();
    }
}
