...
public class Exam_2_5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_continuar = (Button) findViewById(R.id.btn_continua2_5);
        textArea = (EditText) findViewById(R.id.input_res5);
    ...
    public void onBackPressed() {
        ...
        alertOpciones.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(Exam_2_5Activity.this, MenuActivity.class);
    ...
    public void Pregunta(){
        if(Materia == 1){
            ...
            question.setText("Un día en que la rapidez del sonido es de 340 m/s, un tren emite un sonido de " + alumno.getDigito1() + " Hz de frecuencia, ¿Cuál es la frecuencia del sonido escuchado por un observador inmóvil cuando el tren se mueve hacia él con una velocidad de 20 m/s?");
    ...
    public void respuestaContinuar(View view){
        ...
        if(Materia == 1){
            ...
            double resDouble = RespuestaMeteria5();
    ...
    //Metodo Respuesta 1
    public double RespuestaMeteria5(){

        //Texto de Pregunta
        //TVPregunta.setText("Un día en que la rapidez del sonido es de 340 m/s, un tren emite un sonido de " + alumno.getDigito1() + " Hz de frecuencia, ¿Cuál es la frecuencia del sonido escuchado por un observador inmóvil cuando el tren se mueve hacia él con una velocidad de 20 m/s?");
